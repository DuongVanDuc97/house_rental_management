        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleMapLocation = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerPrice = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandlordReply = table.Column<string>(type: "text", nullable: false),
                    HouseId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "d59b0577-f3fe-4a97-a191-13134e401017", "Administrator", "ADMINISTRATOR" },
                    { 2, "d1d0ac98-e9c6-4c85-bfd3-1ae203c94f02", "Landlord", "LANDLORD" },
                    { 3, "9a31cf2e-99e6-40a5-81a5-1c07fa594f31", "Student", "STUDENT" },
                    { 4, "9efaf849-18fb-460a-90b4-0e147212b464", "Staff", "STAFF" }
                });

            migrationBuilder.InsertData(
                table: "RoomStatus",
                columns: new[] { "Id", "CreatedDate", "StatusName" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9350), "Available" },
                    { 2, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9360), "Occupied" },
                    { 3, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9360), "Unavailable" }
                });

            migrationBuilder.InsertData(
                table: "RoomTypes",
                columns: new[] { "Id", "CreatedDate", "RoomTypeName" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Private" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Open" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9370), "Inactive" },
                    { 2, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9390), "Active" },
                    { 3, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9390), "Requested" },
                    { 4, new DateTime(2023, 11, 4, 11, 49, 16, 595, DateTimeKind.Utc).AddTicks(9390), "Rejected" }
                });
